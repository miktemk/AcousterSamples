...
public class TextToSpeechActivity extends Activity implements TextToSpeech.OnInitListener {
    ...
    private static final String[] HELLOS = {
      "pose for first frame, now for first stage left halfway, now for first stage left all the way, now for first stage right halfway, now for first stage right all the way"
    };
